var InflateEmscriptenModule = function(InflateEmscriptenModule) {
  InflateEmscriptenModule = InflateEmscriptenModule || {};
  var Module = InflateEmscriptenModule;
...
function integrateWasmJS(Module) {
  ...
  var wasmTextFile = Module['wasmTextFile'] || "inflate-emscripten.wast";
  var wasmBinaryFile = Module['wasmBinaryFile'] || "inflate-emscripten.wasm";
  var asmjsCodeFile = Module['asmjsCodeFile'] || "inflate-emscripten.asm.js";
...
var Module;
if (!Module) Module = (typeof InflateEmscriptenModule !== 'undefined' ? InflateEmscriptenModule : null) || {};
...
Runtime.GLOBAL_BASE = Runtime.alignMemory(Runtime.GLOBAL_BASE, 4);
...
memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "inflate-emscripten.js.mem" : null;




var STATIC_BUMP = 2064;
...
// {{PRE_LIBRARY}}
  ...
  function _readInput() {
  return Module['_readInput'].apply(null, arguments);
  }
  ...
  Module["SYSCALLS"] = SYSCALLS;function ___syscall6(which, varargs) {SYSCALLS.varargs = varargs;
  try {
   // close
  ...
  function _error() {
  return Module['_error'].apply(null, arguments);
  }
...
Module.asmLibraryArg = { "abort": abort, "assert": assert, "enlargeMemory": enlargeMemory, "getTotalMemory": getTotalMemory, "abortOnCannotGrowMemory": abortOnCannotGrowMemory, "setTempRet0": setTempRet0, "getTempRet0": getTempRet0, "invoke_ii": invoke_ii, "ftCall_ii": ftCall_ii, "invoke_iiii": invoke_iiii, "ftCall_iiii": ftCall_iiii, "invoke_vi": invoke_vi, "ftCall_vi": ftCall_vi, "_pthread_cleanup_pop": _pthread_cleanup_pop, "_error": _error, "___lock": ___lock, "_abort": _abort, "_pthread_cleanup_push": _pthread_cleanup_push, "___syscall6": ___syscall6, "___unlock": ___unlock, "___setErrNo": ___setErrNo, "_emscripten_memcpy_big": _emscripten_memcpy_big, "___syscall54": ___syscall54, "___syscall140": ___syscall140, "_readInput": _readInput, "___syscall146": ___syscall146, "STACKTOP": STACKTOP, "STACK_MAX": STACK_MAX, "DYNAMICTOP_PTR": DYNAMICTOP_PTR, "tempDoublePtr": tempDoublePtr, "ABORT": ABORT, "gb": gb, "fb": fb };
// EMSCRIPTEN_START_ASM
var asm =Module["asm"]// EMSCRIPTEN_END_ASM
(Module.asmGlobalArg, Module.asmLibraryArg, buffer);

var _readValues = Module["_readValues"] = asm["_readValues"];
var _init = Module["_init"] = asm["_init"];
var _readCode = Module["_readCode"] = asm["_readCode"];
var ___syscall_ret = Module["___syscall_ret"] = asm["___syscall_ret"];
var _getBufferSize = Module["_getBufferSize"] = asm["_getBufferSize"];
var _huffmanTreeFromLengths = Module["_huffmanTreeFromLengths"] = asm["_huffmanTreeFromLengths"];
var ___unlockfile = Module["___unlockfile"] = asm["___unlockfile"];
var _cleanup_387 = Module["_cleanup_387"] = asm["_cleanup_387"];
var _initBlock = Module["_initBlock"] = asm["_initBlock"];
var _codeToLength = Module["_codeToLength"] = asm["_codeToLength"];
...
var _codeToDistance = Module["_codeToDistance"] = asm["_codeToDistance"];
var _getOutputBuffer = Module["_getOutputBuffer"] = asm["_getOutputBuffer"];
var _isComplete = Module["_isComplete"] = asm["_isComplete"];
var ___stdout_write = Module["___stdout_write"] = asm["___stdout_write"];
var _pthread_self = Module["_pthread_self"] = asm["_pthread_self"];
var _freeTree = Module["_freeTree"] = asm["_freeTree"];
...
var FUNCTION_TABLE_ii = [b0,asm['___stdio_close']];
var FUNCTION_TABLE_iiii = [b1,asm['___stdout_write'],asm['___stdio_seek'],asm['___stdio_write']];
var FUNCTION_TABLE_vi = [b2,asm['_cleanup_387']];
...
// {{MODULE_ADDITIONS}}
  ...
  return InflateEmscriptenModule;
};
